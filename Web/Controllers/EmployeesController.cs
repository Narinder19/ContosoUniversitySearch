...
namespace Web.Controllers
{
    public class EmployeesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,JobDescription,Number,Department,HourlyPay,Bonus,EmployeeTypeID")] Employee employee)
        {
            ...
            {
                EmployeeMangerFactory emplyeeManagerFactory = new EmployeeMangerFactory();
                IEmployeeManagers employeeManagers = emplyeeManagerFactory.GetEmployeeManger(employee.EmployeeTypeID);
